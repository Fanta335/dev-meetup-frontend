...
export const ConfirmOwnershipDialog: FC<ConfirmOwnershipDialogProps> = memo(
  ({ open, handleCloseDialog }: ConfirmOwnershipDialogProps) => {
    return (
...
ConfirmOwnershipDialog.displayName = 'ConfirmOwnershipDialog';
