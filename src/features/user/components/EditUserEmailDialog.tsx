...
export const EditUserEmailDialog: FC<EditUserEmailDialogProps> = memo(
  ({ open, handleCloseDialog }: EditUserEmailDialogProps) => {
...
EditUserEmailDialog.displayName = 'EditUserEmailDialog';
