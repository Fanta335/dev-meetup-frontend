...
export const EditUserDescriptionDialog: FC<EditUserDescriptionDialogProps> = memo(
  ({ open, handleCloseDialog }: EditUserDescriptionDialogProps) => {
...
EditUserDescriptionDialog.displayName = 'EditUserDescriptionDialog';
